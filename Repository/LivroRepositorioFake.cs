...
namespace _Net_Core__ASP.Net_.Repository
{
    public class LivroRepositorioFake : ILivroRepositorio
    {
        ...
        {
            return obj is LivroRepositorioFake fake &&
                   EqualityComparer<ListaDeLeitura>.Default.Equals(_paraLer, fake._paraLer) &&
                   EqualityComparer<ListaDeLeitura>.Default.Equals(_lendo, fake._lendo) &&
                   EqualityComparer<ListaDeLeitura>.Default.Equals(_lidos, fake._lidos) &&
                   EqualityComparer<ListaDeLeitura>.Default.Equals(ParaLer, fake.ParaLer) &&
                   EqualityComparer<ListaDeLeitura>.Default.Equals(Lendo, fake.Lendo) &&
                   EqualityComparer<ListaDeLeitura>.Default.Equals(Lidos, fake.Lidos) &&
                   EqualityComparer<IEnumerable<Livro>>.Default.Equals(Todos, fake.Todos);
        }
